...
public static class DependencyInjection
{
    ...
    private static IServiceProvider CreateServiceContainer(IConfiguration configuration)
    {
        ...
        serviceCollection.Configure<NotionVisualizerOptions>(o =>
            configuration.GetSection(nameof(NotionVisualizer)).Bind(o));
        serviceCollection.Configure<CytoscapeGeneratorOptions>(o =>
            configuration.GetSection(nameof(CytoscapeGenerator)).Bind(o));
        serviceCollection.Configure<ExcelGeneratorOptions>(
            o => configuration.GetSection(nameof(ExcelGenerator)).Bind(o));
