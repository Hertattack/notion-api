...
public class Visualizer
{
    ...
    {
        return node is PageObject;
    }

    private bool EdgeFilter(NotionObject source, string propertyName,
        OneToManyRelationPropertyValue relationPropertyValue)
    {
        ...
        if (relationPropertyValue.Configuration.Value is not RelationPropertyConfiguration
